...
import { SignUpContainer, UserHeader, PageNumber, DemiHeader, PageBody, InputBody, ButtonWrapper  } from "./Form.style";
...
//   const navigate = useNagivate();
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await axios.post("http://localhost:5050/api/register-teacher", values , { headers: {
...
useEffect ((url, config) => {
    axios.get("http://localhost:5050/api/schools/0/31/name")
    .then(response => {
        console.log(response)
